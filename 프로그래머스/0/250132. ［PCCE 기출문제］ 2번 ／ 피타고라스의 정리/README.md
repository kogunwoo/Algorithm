...
<p>입력 #1</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>3
5
</code><monica-code-tools style="display: contents;"></monica-code-tools></pre></div>
<p>출력 #1</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>16
</code><monica-code-tools style="display: contents;"></monica-code-tools></pre></div>
<p>입력 #2</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>9
10
</code><monica-code-tools style="display: contents;"></monica-code-tools></pre></div>
<p>출력 #2</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>19
</code><monica-code-tools style="display: contents;"></monica-code-tools></pre></div>
<hr>
